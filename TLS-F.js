...
if (process.argv.length <= 2) {
  console.log('\x1b[32m%s\x1b[0m', '[@Hannz - Logs]');
  console.log('\x1b[34m%s\x1b[0m', '[Who To Use Node TLS-F.js [Target URL] [TIME]');
  console.log('\x1b[34m%s\x1b[0m', '[Only L7]');
  console.log('\x1b[35m%s\x1b[0m', '[@Create By : Hanggar]');
	process.exit(-1);
}
